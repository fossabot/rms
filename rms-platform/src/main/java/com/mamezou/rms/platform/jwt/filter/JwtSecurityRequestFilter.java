...
public class JwtSecurityRequestFilter implements ContainerRequestFilter {
    ...
    @Inject
    public JwtSecurityRequestFilter(JsonWebTokenValidator tokenValidator, Config config) {
