...
public class ApplicationInitializerCdiExtensionTest {
    ...
    @AddConfig(key = "configuredCdi.alias.remote.class", value = "com.mamezou.rms.platform.extension.ApplicationInitializerCdiExtensionTest$TestConfigBean1")
    ...
    class RegisterConfiguredBeansTest {
        ...
        @AddConfig(key = "configuredCdi.register.1.class", value = "com.mamezou.rms.platform.extension.ApplicationInitializerCdiExtensionTest$TestConfigBean2")
