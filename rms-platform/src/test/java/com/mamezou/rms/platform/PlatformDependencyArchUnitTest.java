...
public class PlatformDependencyArchUnitTest {
    ...
    static final ArchRule test_jose4jへの依存はimplパッケージのみの定義 =
            noClasses()
                .that()
                    ...
                    .and().resideOutsideOfPackage("com.mamezou.rms.platform.jwt.impl.jose4j..")
            .should()
                .dependOnClassesThat()
                    .resideInAnyPackage(
                        "org.jose4j.jwt.."
    ...
    static final ArchRule test_jwtパッケージ内部の依存関係の定義 =
            noClasses()
                .that()
                    .resideInAPackage("com.mamezou.rms.platform.jwt")
                    .or().resideInAPackage("com.mamezou.rms.platform.jwt.filter..")
                .should()
                    .dependOnClassesThat()
                        .resideInAnyPackage(
                                "com.mamezou.rms.platform.jwt.impl.."
                                );
}
