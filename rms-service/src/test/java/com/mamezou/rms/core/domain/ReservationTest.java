...
class ReservationTest extends PropertyTest {
    ...
    void testBefoeAterValidate() {
        Reservation r = createAllOKReservation();
    ...
    void testPropetyValidation() {
        ...
        // メモ(15文字以内)
        r = createAllOKReservation();
        r.setNote("１２３４５６７８９０１２３４５"); // 境界値:OK
        result = validator.validate(r);
        ConstraintViolationSetAssert.assertThat(result)
            .hasNoViolations();
        ...
        // メモ(15文字より大きい)
        r = createAllOKReservation();
        r.setNote("1234567890123456"); // 境界値:NG
        result = validator.validate(r);
        ConstraintViolationSetAssert.assertThat(result)
            .hasSize(1)
    ...
    private Reservation createAllOKReservation() {
