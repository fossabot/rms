...
import com.mamezou.rms.core.domain.constraint.BeforeAfterDateTime.BeforeAfterDateTimeValidator;
...
public @interface BeforeAfterDateTime {
    ...
    String message() default "{com.mamezou.rms.service.contrains.BeforeAfterDateTime.message}";
